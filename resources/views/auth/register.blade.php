...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-6 col-sm-11">
                <div class="card my-5">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="surname" type="text"
                                           class="form-control rounded-pill @error('surname') is-invalid @enderror" name="surname"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select name="gender" id="gender"
                                            class="form-control rounded-pill @error('gender') is-invalid @enderror">
